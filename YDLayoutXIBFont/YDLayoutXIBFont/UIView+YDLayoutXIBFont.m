...
+ (void)load {
    ...
    Method method5 = class_getInstanceMethod([UITextField class], @selector(button_awakeFromNib));
    ...
    Method method7 = class_getInstanceMethod([UITextView class], @selector(button_awakeFromNib));
